...
public class DbRowMapper implements RowMapper<AperturaTicketData> {
    ...
    public AperturaTicketData mapRow(ResultSet rs, int rowNum) throws SQLException {

    	AperturaTicketData dati_apertura_ticket = new AperturaTicketData();

    	dati_apertura_ticket.setAccount_no(rs.getString(ACCOUNT_NO));
